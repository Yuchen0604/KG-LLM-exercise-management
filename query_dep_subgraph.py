...
# SPARQL query (clean 2-hop dependency with subProperty reasoning)
query = f"""
...
WHERE {{
    ...
    OPTIONAL {{
        ?comp ?rel1 ?dep1 .
        ?rel1 rdfs:subPropertyOf* tpo:hasCompetencyDependency .
        ...
        OPTIONAL {{
            ?dep1 ?rel2 ?dep2 .
            ?rel2 rdfs:subPropertyOf* tpo:hasCompetencyDependency .
